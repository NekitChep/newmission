...
force force REPCOM_HELMET_HUD = "RC_Helmet,SWLB_CEE_Gregor_Helmet,RC_Helmet_AiwhaDikut,RC_Helmet_AiwhaSarge,RC_Helmet_AiwhaTyto,RC_Helmet_AiwhaZag,RC_Helmet_Bravo2,RC_Helmet_Bravo3,RC_Helmet_Bravo4,RC_Helmet_BravoRam,RC_Helmet_DeltaBoss,RC_Helmet_DeltaFixer,RC_Helmet_DeltaScorch,RC_HelmetDeltaSev,RC_Helmet_MPGunner,RC_Helmet_MPMarksman,RC_Helmet_Omega,RC_Helmet_MPRecon,RC_Helmet_MPStealth,RC_Helmet_YayaxCov,RC_Helmet_YayaxDev,RC_Helmet_YayaxJind,RC_Helmet_YayaxYover,RC_Alpha_Helmet_1,RC_Alpha_Helmet_2,RC_Solus_Helmet_02,RC_Helmet_13,RC_Solus_Helmet_47,RC_Solus_Helmet_66,RC_Solus_Helmet_Clever,RC_Solus_Helmet_Kappa,RC_Solus_Helmet_Nort,RC_Solus_Helmet_Omen,RC_Solus_Helmet_Tox,RC_Solus_Helmet_09,RC_Solus_Helmet_45,RC_Solus_Helmet_83,RC_Solus_Helmet_99,RC_Nemesis_Helmet_EOD,RC_Solus_Helmet_Forest,RC_Nemesis_Helmet_Gordon,RC_Solus_Helmet_Sand,RC_Nemesis_Helmet_Scroll,RC_Nemesis_Helmet_Tech,RC_Void_Helmet_Roon,RC_Yivra_Helmet_Aden,RC_Yivra_Helmet_Elyrea,RC_Yivra_Helmet_Goran,RC_Yivra_Helmet_Naak";
force force REPCOM_HUD_ACTIVE_INTRO = true;
REPCOM_HUD_OVERLAY = true;
force force REPCOM_POWERED_SUITS_SETTING = "RC_Uniform,SWLB_CEE_Gregor_Uniform,RC_Solus_Uniform_02,RC_Uniform_13,RC_Solus_Uniform_47,RC_Solus_Uniform_66,RC_Alpha2_Uniform,RC_Alpha1_Uniform,RC_AiwhaSarge_Uniform,RC_AiwhaTyto_Uniform,RC_AiwhaZag_Uniform,RC_Bravo2_Uniform,RC_Bravo3_Uniform,RC_Bravo4_Uniform,RC_BravoRam_Uniform,RC_DeltaBoss_Uniform,RC_DeltaFixer_Uniform,RC_DeltaScorch_Uniform,RC_DeltaSev_Uniform,RC_MPGunner_Uniform,RC_MPMarksman_Uniform,RC_Nemesis_Uniform_EOD,RC_Nemesis_Uniform_Gordon,RC_Nemesis_Uniform_Scroll,RC_Nemesis_Uniform_Tech,RC_OmegaDarman_Uniform,RC_OmegaFi_Uniform,RC_OmegaNiner_Uniform,RC_MPRecon_Uniform,RC_Solus_Uniform_09,RC_Solus_Uniform_45,RC_Solus_Uniform_83,RC_Solus_Uniform_99,RC_Solus_Uniform_Clever,RC_Solus_Uniform_Forest,RC_Solus_Uniform_Kappa,RC_Solus_Uniform_Nort,RC_Solus_Uniform_Omen,RC_Solus_Uniform_Sand,RC_Solus_Uniform_Tox,RC_MPStealth_Uniform,RC_Void_Uniform_Roon,RC_YayaxCov_Uniform,RC_YayaxDev_Uniform,RC_YayaxJind_Uniform,RC_YayaxYover_Uniform,RC_Yivra_Uniform_Aden,RC_Yivra_Uniform_Elyrea,RC_Yivra_Uniform_Goran,RC_Yivra_Uniform_Naak,RC_AiwhaDikut_Uniform";
force force REPCOM_SHIELD_ENERGY = 250;
force force REPCOM_SHIELD_ENERGY_AI = 250;
...
//Grenades
force force Grenade_Drop_Types = "HandGrenade,MiniGrenade,3AS_ThermalDetonator,SWLW_beltGrenade_mag,212th_thermaldet,3AS_BaridumCore,442_impact_mag,442_thermal_det_mag";

// LAMBS Main
force force lambs_main_disableAIDodge = false;
force force lambs_main_disableAIFIeeing = false;
