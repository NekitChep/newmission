...
_waitTill = 1;
_veh = createVehicle ["3AS_AAT", getMarkerPos _rndPoint, [], 0, "NONE"];
[_veh] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh;
_veh1 = createVehicle ["3as_MTT", getMarkerPos _rndPoint, [], 100, "NONE"];
...
/*
_veh24 = [getMarkerPos _rndPoint, 180, "442_argon_covered_cis", east] call BIS_fnc_spawnVehicle;
...
if (_numPlayersByEntity >= 1) then {
_waitTill = 1;
_veh = createVehicle ["MEOP_cont_BigCont", getMarkerPos _rndPoint, [], 0, "NONE"];
_veh setDir (random 360);
_veh setVectorUp surfaceNormal getposatl _veh;
_veh3 = createVehicle ["JLTS_portable_shield_cis", getMarkerPos _rndPoint, [], 35, "NONE"];
...
_veh5 = createVehicle ["k_CIS_Droideka", getPosATL _veh4, [], 15, "NONE"];
...
if (_numPlayersByEntity >= 1) then {
_waitTill = 1;
_veh = createVehicle ["3as_laat_wreck", getMarkerPos _rndPoint, [], 0, "NONE"];
_veh setDir (random 360);
_veh setVectorUp surfaceNormal getposatl _veh;
...
_unitPilot = _group createUnit ["LS_void_pilot_P1", getPosATL _veh, [], 7, "FORM"];
...
_unitCover = _group createUnit ["SWLB_clone_base_P1", getPosATL _veh, [], 7, "FORM"];
...
_rndClassNames = ["SWLB_clone_base_P1","SWLB_clone_sergeant_base_P1"] call BIS_fnc_SelectRandom;
...
_veh5 = createVehicle ["k_CIS_Droideka", getPosATL _veh, [], 90, "NONE"];
[_veh5] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh5;
...
_unit148 = _group228 createUnit ["ls_cis_b1Shotgun_standart", getMarkerPos _rndPoint, [], 250, "FORM"];
[_unit148] execVM "automissions\deleteDeadObject.sqf";
_unit248 = _group228 createUnit ["ls_cis_b1Shotgun_standart", getMarkerPos _rndPoint, [], 250, "FORM"];
...
_veh5 = createVehicle ["k_CIS_Droideka", getMarkerPos _rndPoint, [], 15, "FLY"];
[_veh5] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh5;
...
if (_numPlayersByEntity >= 1) then {
_waitTill = 1;
_veh = createVehicle ["ls_hmp_wreck", getMarkerPos _rndPoint, [], 0, "NONE"];
_veh setDir (random 360);
_veh setVectorUp surfaceNormal getposatl _veh;
_veh1 = createVehicle ["ls_hmp_wreck", getMarkerPos _rndPoint, [], 35, "NONE"];
...
_veh7 = createVehicle ["JLTS_portable_shield_cis", getMarkerPos _rndPoint, [], 35, "NONE"];
...
_veh4 = createVehicle ["3as_MTT", getMarkerPos _rndPoint, [], 70, "NONE"];
_veh4 setDir (random 360);
_veh4 setVectorUp surfaceNormal getposatl _veh4;
{
_x setDamage 1;
...
if (_numPlayersByEntity >= 1) then {
_waitTill = 1;
_veh = createVehicle ["3AS_GAT", getMarkerPos _rndPoint, [], 0, "NONE"];
[_veh] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh;
...
_waitTill = 1;
_group = createGroup east;
_officer = _group createUnit ["ls_cis_oomOfficer_standart", getMarkerPos _rndPoint, [], 10, "FORM"];
_officer setVariable ["DataTaken",0,true];
_unit1 = _group createUnit ["ls_cis_b1Shotgun_standart", getPosATL _officer, [], 3, "FORM"];
[_unit1] execVM "automissions\deleteDeadObject.sqf";
_unit2 = _group createUnit ["ls_cis_b1Shotgun_standart", getPosATL _officer, [], 3, "FORM"];
...
_veh = createVehicle ["k_CIS_Droideka", getPosATL _officer, [], 5, "NONE"];
[_veh] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh;
...
_group1 = createGroup east;
for "_i" from 1 to 5 do {
_rndClassNames = ["SWLB_b1_Security","lsd_cis_bxAssassin_specops"] call BIS_fnc_SelectRandom;
_unit = _group1 createUnit [_rndClassNames, getMarkerPos _rndPoint, [], 55, "FORM"];
[_unit] execVM "automissions\deleteDeadObject.sqf";
_unit addEventHandler ["Hit",{
_whoHitted = _this select 0;
...
_rndClassNames = ["SWLB_b1_base","SWLB_b1_sl_base","SWLB_b1_heavy_base","SWLB_b1_at_base","lsd_cis_bxAssassin_specops"] call BIS_fnc_SelectRandom;
...
_unit1 = _group1 createUnit ["ls_cis_b1Shotgun_standart", getMarkerPos _rndPoint, [], 3, "FORM"];
[_unit1] execVM "automissions\deleteDeadObject.sqf";
_unit2 = _group1 createUnit ["ls_cis_b1Shotgun_standart", getMarkerPos _rndPoint, [], 3, "FORM"];
[_unit2] execVM "automissions\deleteDeadObject.sqf";
...
_veh = createVehicle ["k_CIS_Droideka", getMarkerPos _rndPoint, [], 5, "FLY"];
[_veh] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh;
...
_veh1 = createVehicle ["k_CIS_Droideka", getMarkerPos _rndPoint, [], 15, "FLY"];
[_veh1] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh1;
...
_group = createGroup west;
for "_i" from 1 to 5 do {
_rndClassNames = ["SWLB_clone_base_P1","SWLB_clone_sergeant_base_P1","lsd_cis_bxAssassin_specops"] call BIS_fnc_SelectRandom;
...
[1001, ["Командир Банты: Всем, кто меня слышит, мы попали в засаду противника по пути на аванпост, нам нужна помощь, срочно! Противник на 3 часа, 150 метров...", "PLAIN DOWN"]] remoteExec ["cutText"];
{playSound ["AT_TE_help_start",true];} remoteExec ["call",0];

sleep 7;
[1001, ["Командир Банты: Воздух, у нас воздух! Чёрт, ого...*помехи*", "PLAIN DOWN"]] remoteExec ["cutText"];
sleep 1.9;
[1001, ["Командир Банты: Назад, я сказал назад, НАЗАД!....*помехи*", "PLAIN DOWN"]] remoteExec ["cutText"];
...
_rndPoint = _coordinates call BIS_fnc_SelectRandom;
[true, [_actTaskId], ["При доставке припасов наши попали под массированый вражеский огонь как с земли, так и с воздуха. Сами они долго не протянут. Нужно помочь нашим ребятам. По прибытию, даже если не удастся спасти наших, зачистите район полностью.", "Капкан", "Помочь"], getMarkerPos _rndPoint, 1, 2, true] call BIS_fnc_taskCreate;
...
_veh = createVehicle ["212th_B_APC_Wheeled_01_cannon_F", getMarkerPos _rndPoint, [], 25, "FLY"];
createVehicleCrew _veh;
_veh addEventHandler ["Killed",{
_whoHitted = _this select 0;
_hitMan = _this select 1;
...
_veh1 = createVehicle ["212th_B_APC_Wheeled_01_cannon_F", getMarkerPos _rndPoint, [], 55, "FLY"];
createVehicleCrew _veh1;
_veh1 addEventHandler ["Killed",{
_whoHitted = _this select 0;
_hitMan = _this select 1;
...
_veh24 = [getMarkerPos _rndPoint, 180, "RD501_marid_MkII_CIS", east] call BIS_fnc_spawnVehicle; // НАДО БЛЯДЬ ПОСМОТРЕТЬ
_veh2 = _veh24 select 0;
[_veh2] execVM "automissions\deleteDeadObject.sqf";
createVehicleCrew _veh2;
_veh2 engineOn true;
...
_veh3 = createVehicle ["ls_ground_aat_blue", getMarkerPos _rndPoint, [], 55, "FLY"];
