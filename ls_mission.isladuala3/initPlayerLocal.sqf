...
RC_ARC_power = [player] spawn 
{
	while {true} do 
	{
		...
		if ((_nameplayer1 find "RC" !=-1) || (_nameplayer1 find "Rier" !=-1))
		then 
		{
...
UniformList = [
    "RC_Nemesis_Uniform_Tech","RC_Void_Uniform_Roon","RC_Nemesis_Uniform_Scroll","RC_Nemesis_Uniform_Gordon","RC_Nemesis_Uniform_EOD",
	"RC_Uniform","RC_MPGunner_Uniform","RC_Uniform_13","SWLB_CEE_Gregor_Uniform","RC_Solus_Uniform_99",
...
//["ace_unconscious", {[] execVM "scripts/fn_autobacta.sqf";}] call CBA_fnc_addEventHandler;
